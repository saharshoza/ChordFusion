...
//	MyContainer auxList;
//	public FusionPrimaryMap(int numFaults, int primaryId, Map<Integer,PrimaryNode<Integer>> primaryMap){
...
//					while (it.hasNext()) {
//				        Entry<Integer,PrimaryNode<Integer>> pairs = it.next();
...
//    	FusionPrimaryMap fusibleMap = new FusionPrimaryMap(numFaults, id,map);
